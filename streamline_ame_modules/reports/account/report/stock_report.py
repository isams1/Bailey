...
class wrapped_streamline_ame_report_stock_report(report_sxw.rml_parse):
    
    def __init__(self, cr, uid, name, context):
        super(wrapped_streamline_ame_report_stock_report, self).__init__(cr, uid, name, context=context)
...
class report_streamline_ame_stock_report(osv.AbstractModel):
    _name = 'report.streamline_ame_modules.report_streamline_ame_stock_report'
    _inherit = 'report.abstract_report'
    _template = 'streamline_ame_modules.report_streamline_ame_stock_report'
    _wrapped_report_class = wrapped_streamline_ame_report_stock_report
